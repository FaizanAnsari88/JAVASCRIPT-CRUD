...
newMemberAddBtn.addEventListener('click', ()=> {
    ...
    modalTitle.innerHTML = "FAIZAN E-PAY & SERVICES"
    ...
    if(getData.length > 0){
        for(var i=tab_start; i<tab_end; i++){
            ...
            if(staff){
                ...
                <td>${staff.totalVal}</td>
                <td>${staff.phoneVal}</td>
                <td>
                    <button onclick="readInfo('${staff.picture}', '${staff.fName}', '${staff.lName}', '${staff.ageVal}', '${staff.cityVal}', '${staff.positionVal}', '${staff.salaryVal}','${staff.totalVal}', '${staff.sDateVal}','${staff.phoneVal}')"><i class="fa-regular fa-eye"></i></button>

                    <button onclick="editInfo('${i}', '${staff.picture}', '${staff.fName}', '${staff.lName}', '${staff.ageVal}', '${staff.cityVal}', '${staff.positionVal}', '${staff.salaryVal}', '${staff.sDateVal}','${staff.phoneVal}')"><i class="fa-regular fa-pen-to-square"></i></button>
...
function readInfo(pic, fname, lname, Age, City, Position, Salary, SDate,total, Phone){
    imgInput.src = pic
    fName.value = fname
    lName.value = lname
    age.value = Age
    ...
    salary.value = Salary
    sDate.value = SDate
    // yaha se delete kiya hu email wala
    total.value=total
    phone.value = Phone
...
function editInfo(id, pic, fname, lname, Age, City, Position, Salary, SDate, total, Phone){
    isEdit = true
    editId = id
...
form.addEventListener('submit', (e)=> {
    ...
    const information = {
        ...
        // yaha change kiya hu mtb delete emailVal: email.value,
...
filterData.addEventListener("input", ()=> {
    ...
    if(searchTerm !== ""){
        ...
        const filteredData = originalData.filter((item) => {
            ...
            const phone = item.phoneVal.toLowerCase()
